...
const provenance = read('scripts/verify-desktop-release-provenance.mjs');
...
requireText(feed, 'node scripts/verify-desktop-release-provenance.mjs', 'feed promotion runs the reusable release provenance verifier');
requireText(provenance, "spawnSync('git', ['merge-base', '--is-ancestor', normalizedCommit, normalizedMainRef]", 'release provenance verifier requires canonical main ancestry');
requireText(provenance, 'Desktop preview release must be marked prerelease.', 'release provenance verifier enforces preview prerelease semantics');
requireText(provenance, 'Desktop stable release must not be marked prerelease.', 'release provenance verifier enforces stable release semantics');
