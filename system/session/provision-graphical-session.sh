...
for source_file in \
  ...
  system/apps/swir-screenshot.py \
  system/apps/swir-screenshot.desktop \
  system/apps/swir-calculator.py \
  system/apps/swir-calculator.desktop \
  system/apps/swir-clock.py \
  system/apps/swir-clock.desktop \
  system/apps/swir-text-editor.py \
  system/apps/swir-text-editor.desktop \
  system/apps/swir-archive-manager.desktop \
...
install -m 0755 "$SOURCE_ROOT/system/apps/swir-screenshot.py" "$(safe_target /usr/local/bin/swir-screenshot)"
install -m 0644 "$SOURCE_ROOT/system/apps/swir-screenshot.desktop" "$(safe_target /usr/share/applications/swir-screenshot.desktop)"
...
install -m 0755 "$SOURCE_ROOT/system/apps/swir-clock.py" "$(safe_target /usr/local/bin/swir-clock)"
install -m 0644 "$SOURCE_ROOT/system/apps/swir-clock.desktop" "$(safe_target /usr/share/applications/swir-clock.desktop)"
install -m 0755 "$SOURCE_ROOT/system/apps/swir-text-editor.py" "$(safe_target /usr/local/bin/swir-text-editor)"
install -m 0644 "$SOURCE_ROOT/system/apps/swir-text-editor.desktop" "$(safe_target /usr/share/applications/swir-text-editor.desktop)"
install -m 0644 "$SOURCE_ROOT/system/apps/swir-archive-manager.desktop" "$(safe_target /usr/share/applications/swir-archive-manager.desktop)"
...
chroot "$ROOTFS" /usr/bin/python3 -m py_compile \
  ...
  /usr/local/bin/swir-screenshot \
  /usr/local/bin/swir-calculator \
  /usr/local/bin/swir-clock \
  /usr/local/bin/swir-text-editor \
...
verify_trusted_regular_file /usr/local/bin/swir-screenshot yes
verify_trusted_regular_file /usr/share/applications/swir-screenshot.desktop no
...
verify_trusted_regular_file /usr/local/bin/swir-clock yes
verify_trusted_regular_file /usr/share/applications/swir-clock.desktop no
verify_trusted_regular_file /usr/local/bin/swir-text-editor yes
verify_trusted_regular_file /usr/share/applications/swir-text-editor.desktop no
verify_trusted_regular_file /usr/share/applications/swir-archive-manager.desktop no
...
printf 'SWIR graphical session staged: mode=%s theme=swir login=greetd compositor=weston native-shell=gtk4 native-apps=backup,browser,player,photo-studio,pdf-viewer,screenshot,calculator,clock,text-editor,archive,files,hardware,network,notes,settings,software,system-monitor,terminal,updates package-broker=peer-polkit-journaled\n' "$MODE"
